...
def handle_message(event):
    ...
    if msg_from_user.lower() == '/help':
        ...
        bubble = BubbleContainer(
            direction='ltr',
            hero=ImageComponent(
                url='https://cdn3.iconfinder.com/data/icons/medical-7/512/ring_bell_life_phone_float_call_vacation-512.png',
                size='full',
                aspect_ratio='1:1',
                aspect_mode='cover'
            ...
            body=BoxComponent(
                layout='vertical',
                contents=[
                    TextComponent(text='Hotline Corona', weight='bold', size='md', align='center')
                ],
            ),
            footer=BoxComponent(
                layout='vertical',
